        ...
        <div className={styles.view}>
            <div className={styles.photoRing}>
                ...
                <div className={styles.infoPills}>
                    <div className={`${styles.infoPill} ${styles.pillStreets}`} data-pill="streets">
                    ...
                    <div className={`${styles.infoPill} ${styles.infoPillLg} ${styles.pillPokemon}`} data-pill="pokemon">
                        <div aria-hidden className={styles.infoPillBg} />
                        <div className={styles.infoPillEmoji}>🃏</div>
                    ...
                    <div className={`${styles.infoPill} ${styles.pillCities}`} data-pill="cities">
                        <div aria-hidden className={styles.infoPillBg} />
                    ...
                    <div className={`${styles.infoPill} ${styles.infoPillLg} ${styles.pillCycling}`} data-pill="cycling">
                        <div aria-hidden className={styles.infoPillBg} />
                        <div className={styles.infoPillEmoji}>🚴</div>
