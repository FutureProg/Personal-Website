...
type _CoercedEnvSchema_a2de6f6b = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_a2de6f6b> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_a2de6f6b, 'CORS_ORIGIN' | 'GITHUB_POLL_INTERVAL_MS' | 'GITHUB_USERNAME' | 'PORT'>> {}
}
...
type _EnvSchemaAsStrings_a2de6f6b = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_a2de6f6b {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_a2de6f6b {}
  }
}